...
def bfs(graph, start):
    ...
    visited = set()
    # Словарь расстояний до каждой вершины, изначально бесконечность
...
# Считываем матрицу смежности из файла 'graph.txt'
graph = read_adjacency_matrix('graph.txt')

# Записываем результат обхода графа в файл 'output.txt'
